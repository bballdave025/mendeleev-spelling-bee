...
You definitely want to go see [The Basics](), as there's a lot of fun down there. However, I want to look at the test-driven development used to make this think work with Latin and Cyrillic script versions of the periodic table. How did I get a Cyrillic version of the periodic table? Well, that will be discussed in the Chain of Though (CoT) propmting section. I must say that it's not quite pure CoT, it's a step beyond. More on that later.
